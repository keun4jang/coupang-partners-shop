...
export const Background: React.FC<{
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: COLORS.cream }}>
      ...
      <AbsoluteFill
        style={{
          // 빛 번짐 글로우. 예전엔 화면 24% 지점에 알파 0.5 로 깔렸는데, 하필 그 자리가
          // 훅 자막 위치라 자막 뒤를 가장 밝게 만들고 있었다(실측: 26% 밴드 186 으로
          // 대조 구간 162 보다 밝음). 자막을 피해 아래로 내리고 세기를 낮춘다.
          background: `radial-gradient(58% 36% at 50% 58%, rgba(255,253,248,0.28) 0%, rgba(255,253,248,0) 70%)`,
        }}
      />
