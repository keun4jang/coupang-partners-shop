...
const APPEAL_RULES: Array<[RegExp, number, string]> = [
  ...
  // 신제품/신상 - "이런 것도 나왔대" 훅. 2026-09-18: 카테고리를 넓히면서
  // "새로 나온 물건"을 우선 소개해 달라는 요청에 맞춰 추가. 위 신박/아이디어
  // 규칙과 별개 그룹이라 제목에 둘 다 걸리면(예: "신박한 신상 아이디어템")
  // 가산이 겹친다 - 의도한 것이다. 신기함과 신제품 둘 다인 상품이 더
  // 혹하는 건 맞으므로.
  [/신제품|신상|따끈따끈|런칭|출시\s*기념|이번\s*(에\s*)?신상/, 3, "신제품/신상"],
