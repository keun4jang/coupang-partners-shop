...
const NOISE_WORD =
  /^(화이트|블랙|그레이|베이지|아이보리|실버|브라운|네이비|핑크|옐로우|오렌지|그린|블루|레드|퍼플|투명|반투명|크림|차콜|은색|검정색?|흰색|단일색상|단일상품|단일\s*제품|혼합색상|혼합|랜덤발송|무료배송|증정|사은품|정품|단품|본품|본체|택1|단순배송상품|캡형|캡|리필|타입|형태|포함|구성|옵션|프로모션|할인|특가|세일|이벤트|베스트|신상|최저가|핫딜|반값|떨이|초특가|역대급|대박|인기1위|판매1위|1위|강추|필수템|인생템)$/;
